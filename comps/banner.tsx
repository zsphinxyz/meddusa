  ...
  return (
    <div className="overflow-hidden">
        <div className="w-fit min-h-full flex justify-center items-center">
            ...
            <div className=" px-10 w-screen min-h-fit h-96 bg-[url(../assets/slider.jpg)] bg-cover bg-no-repeat flex gap-7 flex-col justify-center items-start">
                <h1 className=" font-semibold text-4xl">We Provide <span className="text-blue-500">Medical </span> Services That You Can <span className="text-blue-500">Trust!</span></h1>
